"""
Django settings for crypticcomm_ai project.
...
SECRET_KEY = 'django-insecure-4#(d!l1p$a2=k-g!3&r6m34b2rwdx44h)4rworx7*jg^yw_s)d'
...
ROOT_URLCONF = 'crypticcomm_ai.urls'
...
WSGI_APPLICATION = 'crypticcomm_ai.wsgi.application'
